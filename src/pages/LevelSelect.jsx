...
const TRANSLATIONS = {
    hi: {
        question: 'आपको कितनी English आती है?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'बिलकुल नहीं', sub: 'English से बिल्कुल अनजान' },
    ...
    te: {
        question: 'మీకు ఎంత English వచ్చు?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'అసలు రాదు', sub: 'English అసలు తెలియదు' },
    ...
    mr: {
        question: 'तुम्हाला किती English येते?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'अजिबात नाही', sub: 'English अजिबात येत नाही' },
    ...
    bn: {
        question: 'আপনি কতটা ইংরেজি জানেন?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'একদমই না', sub: 'ইংরেজি একদম বুঝি না' },
    ...
    ta: {
        question: 'உங்களுக்கு எவ்வளவு ஆங்கிலம் தெரியும்?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'ஒன்றும் தெரியாது', sub: 'ஆங்கிலம் அறவே தெரியாது' },
    ...
    kn: {
        question: 'ನಿಮಗೆ ಎಷ್ಟು English ಗೊತ್ತು?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'ಏನೂ ಗೊತ್ತಿಲ್ಲ', sub: 'ಇಂಗ್ಲಿಷ್ ಸ್ವಲ್ಪವೂ ಗೊತ್ತಿಲ್ಲ' },
    ...
    gu: {
        question: 'તમને કેટલી English આવડે છે?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'બિલકુલ નહીં', sub: 'English બિલકુલ આવડતી નથી' },
    ...
    pa: {
        question: 'ਤੁਹਾਨੂੰ ਕਿੰਨੀ English ਆਉਂਦੀ ਹੈ?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'ਬਿਲਕੁਲ ਨਹੀਂ', sub: 'English ਬਿਲਕੁਲ ਨਹੀਂ ਆਉਂਦੀ' },
    ...
    or: {
        question: 'ତୁମ English କେତେ ଜଣା?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'ଆଦୌ ଜଣା ନାହିଁ', sub: 'English ଆଦୌ ଜଣାଯାଏ ନାହିଁ' },
    ...
    ml: {
        question: 'നിങ്ങൾക്ക് എത്ര ഇംഗ്ലീഷ് അറിയാം?',
        levels: [
            { id: 'zero', icon: '🌱', label: 'ഒട്ടും അറിയില്ല', sub: 'ഇംഗ്ലീഷ് ഒട്ടും പഠിച്ചിട്ടില്ല' },
    ...
    ur: {
        question: 'آپ کتنی English جانتے ہیں؟',
        levels: [
            { id: 'zero', icon: '🌱', label: 'بالکل نہیں', sub: 'English بالکل نہیں آتی' },
